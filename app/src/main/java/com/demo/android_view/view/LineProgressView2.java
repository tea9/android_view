 ...
 */
public class LineProgressView2 extends View {
    ...
    public LineProgressView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initPaint() {
        ...
        xxPaint = getPaint(Paint.Style.STROKE,Color.RED,30);
...
//        canvas.drawRect(new RectF(20, 20, 120, 120), xxPaint);
//        canvas.drawCircle(120, 70, 50, xxPaint);
//        canvas.clipRect(new RectF(20, 20, 120, 120));
//        Path path = new Path();
//        path.addCircle(120, 70, 50, Path.Direction.CCW);
//        canvas.clipPath(path, Region.Op.INTERSECT);
//        canvas.drawColor(Color.GREEN);
        xxPaint.setStrokeCap(Paint.Cap.ROUND);

        canvas.drawLine(startX,height/2,startX+2,height/2,xxPaint);
        xxPaint.setStrokeCap(Paint.Cap.BUTT);
        xxPaint.setColor(Color.GREEN);
        canvas.drawLine(startX,height/2,lenth,height/2,xxPaint);
